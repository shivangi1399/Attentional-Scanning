...
save_root = '/mnt/hpc/projects/MWSampling/4Shivangi/Plots/correlation/klecks/cp10_till_100/lfp/all_loc_difflev';
...
% Folder to save all figures
save_root = '/mnt/hpc/projects/MWSampling/4Shivangi/Plots/correlation/klecks/ph55_till_100/lfp/only_miss/loc_difflev/all_dlev';
if ~exist(save_root, 'dir')
    mkdir(save_root);
end
