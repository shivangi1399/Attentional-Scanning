function phase_coherence_RT_perm_pos(cfg_fun)
% H2 permutation: shuffle RT globally across hit trials, then compute coherence
...
for perm = 1:permut_n
    rt_perm = rt(perm_indices{perm});   % shuffle RT globally across hit trials
