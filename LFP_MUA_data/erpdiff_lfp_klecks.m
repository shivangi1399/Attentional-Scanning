...
% Code description:
% -----------------
% code to compute the  average LFP ERP per condition and the condtion
...
for isess = length(session_names)
    ...
    % figure
    cd('/mnt/hpc/projects/MWSampling/4Shivangi/Plots/Hitvsmiss/erpdiff_klecks/lfp')
