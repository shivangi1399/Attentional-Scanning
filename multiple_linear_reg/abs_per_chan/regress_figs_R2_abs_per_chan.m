% =====================================================================
% Figures: regression R² (H1+H4 — abs_per_chan/)
%
% Loads per-channel R² results from regress_stats_R2_abs_per_chan.m
% and produces visualisations of variance explained by the full phase
% model (sin(φ) + cos(φ)) across frequencies and channels.
%
