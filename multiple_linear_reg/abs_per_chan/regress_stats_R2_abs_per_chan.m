...
for a = 1:numel(animals)
    ...
    results_folder = fullfile('/mnt/hpc/projects/MWSampling/4Shivangi', ...
        ['results_' animalName], 'multi_lin_reg', 'abs_per_chan', 'cp10_till_100');
...
for d = 1:length(Y_vars)
    ...
    for a = 1:nAnimals
        animal_folder = fullfile('/mnt/hpc/projects/MWSampling/4Shivangi', ...
            ['results_' animals{a}], 'multi_lin_reg', 'abs_per_chan', 'cp10_till_100');
    ...
    % Save
    monkey_save_dir = fullfile('/mnt/hpc/projects/MWSampling/4Shivangi/results_combined/multi_lin_reg/abs_per_chan/cp10_till_100', depVarName);
